...
namespace Espeon.Test {
    public class TimeSpanParserTests {
        ...
        public void TestTryParseIn(string input, bool expectedResult, TimeSpan expectedTimeSpan) {
            var parser = new TimeSpanParser(new Dictionary<string, TimeUnit> {
                ["s"] = SECOND,
                ["m"] = MINUTE,
                ["h"] = HOUR,
                ["d"] = DAY,
        ...
        private static object[][] StringsAndExpectedResults() {
            return new [] {
                ...
                new object[] { "long string 1", false, TimeSpan.Zero },
                ...
                new object[] { "1mth", true, TimeSpan.FromSeconds((int) MONTH) },
                new object[] { "1yr", true, TimeSpan.FromSeconds((int) YEAR) },
