    ...
    public class Moderation : EspeonModuleBase
    {
        ...
        public async Task ViewWarningsAsync([Remainder] IGuildUser targetUser)
        {
            ...
            foreach (var warning in foundWarnings)
            {
                ...
                sb.Append("**Issued On**: ")
                    .AppendLine(DateTimeOffset.FromUnixTimeMilliseconds(warning.IssuedOn)
            ...
            IGuildUser user)
        {
            ...
            await Task.WhenAll(user.AddRoleAsync(role, new RequestOptions
            {
                AuditLogReason = "Reaction rights revoked"
            }), SendOkAsync(1));
        }
            ...
            IGuildUser user)
        {
            ...
            await Task.WhenAll(user.RemoveRoleAsync(role, new RequestOptions
            {
                AuditLogReason = "Reaction rights restored"
            }), SendOkAsync(1));
        }
            ...
            IGuildUser user)
        {
            return Task.WhenAll(
                Context.Channel.AddPermissionOverwriteAsync(user,
                    ...
                    {
                        AuditLogReason = "User blocked from channel"
                    }),
                SendOkAsync(0));
        }
